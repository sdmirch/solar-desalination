function [ G_on,G_cnb,G_cb ] = SMD_SUN( n,A,phi )
...
Tb = r0*(0.4237-0.00821*((6-A)^2))+ r1*(0.5055+0.00595*((6.5-A)^2))*exp(-1*rk*(0.2711+(0.01858*((2.5-A)^2)))/cos(theta_z));
...
G_on = G_sc*(1+(0.033*cosd(360*n/365)));
%G_cnb clear sky beam normal radiation, W/m2
G_cnb = Tb*G_on;
%G_cd clear sky diffuse radiation, W/m2
G_cd = G_sc*(1+0.033*cosd(360*n/365))*Td*cosd(theta_z);
