...
%Description:
%Old program that loads user picked decision values from SMD_decision
...
global Table_MEM n A phi N_auto gamma beta...
    ...
    cost_pex cost_constant ModCondRatio N_b...
    water_req n_hwpump n_blower
...
%Loads decision variables
SMD_decision(ModCondRatio);
load SMD_decision.mat;
